...
contract LendingPoolMock {
    ...
    function flashLoan(
        ...
        premiums[0] = (amounts[0] * FLASHLOAN_PREMIUM_TOTAL) / 10000;
        ...
        require(
            AaveFlashBorrowerLike(receiverAddress).executeOperation(
                assets,
                amounts,
                premiums,
                msg.sender,
        ...
        IERC20(assets[0]).transferFrom(receiverAddress, aTokenAddress, amounts[0] + premiums[0]);
    }
    ...
    /**
     * @dev Adds a reserve to the reserves list, as an ATokenMock and underlying MockToken pair
     * @param aToken The address of the reserve aToken
     **/
    function addReserve(address aToken) external {
