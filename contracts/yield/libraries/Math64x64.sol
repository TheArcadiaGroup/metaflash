...
library Math64x64 {
    ...
    function sqrt(int128 x) internal pure returns (int128) {
        require(x >= 0);
        return int128(sqrtu(uint256(int256(x)) << 64, 0x10000000000000000));
    }
    ...
    function log_2(int128 x) internal pure returns (int128) {
        ...
        uint256 ux = uint256(int256(x)) << (127 - uint256(msb));
    ...
    function ln(int128 x) internal pure returns (int128) {
        ...
        return
            int128(
                uint128((uint256(uint128(log_2(x))) * 0xB17217F7D1CF79ABC9E3B39803F2F6AF) >> 128)
            );
    }
