...
contract UniswapERC3156 is IERC3156FlashLender, UniswapV2FlashBorrowerLike {
    ...
    function uniswapV2Call(
        ...
        // decode data
        (address origin, IERC3156FlashBorrower receiver, address token, bytes memory userData) = abi
            .decode(data, (address, IERC3156FlashBorrower, address, bytes));
        ...
        IERC20(token).transferFrom(address(receiver), msg.sender, amount + fee);
    }
}
